...
local FloD = Tabs.Status:AddParagraph({
...
local Check_Kitsu = Tabs.Status:AddParagraph({
...
local Check_Volcano = Tabs.Status:AddParagraph({
...
local CheckTier = Tabs.Status:AddParagraph({
...
local Process = Tabs.Status:AddParagraph({
...
local CheckingBone = Tabs.Status:AddParagraph({
    Title = " Bones :",
    Content = ""
})
spawn(function()
